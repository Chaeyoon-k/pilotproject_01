	...
	<h1 class="text-center" style="margin-bottom: 50px;">상품 등록</h1>
		...
		<label  class="form-label mt-4">가게 선택</label>
			    ...
			    <input class="form-check-input" type="radio" name="radioDefault" id="radioDefault1">
			        <label class="form-check-label" for="radioDefault1" name="category_id" value="1" checked>식품</label><br>
			    <input class="form-check-input" type="radio" name="radioDefault" id="radioDefault2">
			        <label class="form-check-label" for="radioDefault2" name="category_id" value="2"> 가구</label><br>
			    <input class="form-check-input" type="radio" name="radioDefault" id="radioDefault3">
			         <label class="form-check-label" for="radioDefault3" name="category_id" value="3"> 도서</label><br>
			    <input class="form-check-input" type="radio" name="radioDefault" id="radioDefault4">
			         <label class="form-check-label" for="radioDefault4" name="category_id" value="4"> 스포츠/레저</label><br>
			    <input class="form-check-input" type="radio" name="radioDefault" id="radioDefault5">
			         <label class="form-check-label" for="radioDefault5" name="category_id" value="5"> 출산/유아용품</label><br>
			    <input class="form-check-input" type="radio" name="radioDefault" id="radioDefault6">
			         <label class="form-check-label" for="radioDefault6" name="category_id" value="6"> 반려동물용품</label><br>
			    <input class="form-check-input" type="radio" name="radioDefault" id="radioDefault7">
			         <label class="form-check-label" for="radioDefault7" name="category_id" value="7"> 뷰티</label>
